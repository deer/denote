...
ai-summary: Add standalone routes (legal, about, landing pages) outside the docs layout. Fresh file-system routing with automatic PageLayout wrapping and access to DenoteContext.
ai-keywords: [
  custom pages,
  routes,
  Fresh,
